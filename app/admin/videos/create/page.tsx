...
export default function CreateVideoPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="py-20 px-[10%] text-center">
          ...
          <p className="text-gray-600">Anda harus login untuk membuat video.</p>
        </div>
        <Footer />
      </div>
    )
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        variant: "success",
        title: formData.status === "draft" ? "Draft saved!" : "Video submitted!",
        description:
          formData.status === "draft"
            ? "Your video has been saved as draft."
      ...
      <div className="py-8 px-[10%]">
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Buat Video Baru</h1>
              <p className="text-gray-600 mt-2">Upload dan bagikan video pembelajaran Anda</p>
            </div>
          </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="text-xs text-gray-500 mt-4">
                    <p>• Video akan direview oleh admin sebelum dipublikasi</p>
